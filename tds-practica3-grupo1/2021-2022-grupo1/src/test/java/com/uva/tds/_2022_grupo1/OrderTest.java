...
class OrderTest {	
	...
	void setUp(){
	    ...
	    pedido = new Order(idOrder,productos,fechaCreacion);
...
/*Tests Creacion*/
	...
	void testCreacionPedidoListaProductosNula() {
		assertThrows(IllegalArgumentException.class,()->{new Order(idOrder,null,fechaCreacion);});
	}
	...
	void testCreacionPedidoListaProductosVacia() {
		...
		assertThrows(IllegalArgumentException.class,()->{new Order(idOrder,productosVacia,fechaCreacion);});
	}
	
	@Test
	@Tag("TDD")
	void testCreacionPedidoFechaCreacionNula() {
		assertThrows(IllegalArgumentException.class,()->{new Order(idOrder,productos,null);});
	}
...
/*Tests Estado Recibido*/
	...
	void testEstadoRecibidoAnnadirNuevoProducto() {
		...
		assertEquals(idOrder, pedido.getId());
...
/*Tests metodo Equals*/
	...
	void testEqualsPedidoIdIguales() {
		...
		Order nuevoPedido = new Order(idOrder,nuevoproductos,nuevaFechaCreacion);
